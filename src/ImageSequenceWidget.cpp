	...
	_ui{ std::make_unique<Ui::ImageSequenceWidget>() }
{
	...
	connect(_ui->imageWidthSpinBox, qOverload<int>(&QSpinBox::valueChanged), this, &ImageSequenceWidget::onImageWidthChanged);
	connect(_ui->imageHeightSpinBox, qOverload<int>(&QSpinBox::valueChanged), this, &ImageSequenceWidget::onImageHeightChanged);
